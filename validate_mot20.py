...
def run_mot20_evaluation(model_path, output_dir, tracker_yaml="yolojdetracker.yaml"):
    """
    对指定模型运行MOT20评估
    """
    print("=" * 60)
    ...
    # MOT20数据集配置
    dataset_name = 'MOT20/val'
    seqmap_file = './tracker/evaluation/TrackEval/data/gt/mot_challenge/seqmaps/MOT20-val.txt'
...
if __name__ == "__main__":
    # 配置参数
    MODEL_PATH = "reid_xps/CH-jde-baseline-b8-e100-sz1280-20260322-163647/weights/best.pt"
    OUTPUT_DIR = "reid_xps/CH-jde-baseline-b8-e100-sz1280-20260322-163647"
    TRACKER_YAML = "yolojdetracker.yaml"

    # 运行评估
    run_mot20_evaluation(MODEL_PATH, OUTPUT_DIR, TRACKER_YAML)